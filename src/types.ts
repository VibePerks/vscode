// Shared wire types for the VibePerks VS Code plugin. These mirror the backend API
// contract exactly (GET /v1/ads/serve, POST /v1/impressions) so the plugin stays a
// thin client over the same contract the other adapters use.
