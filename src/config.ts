...
// DEFAULT_API_BASE targets the prod backend; override with $VIBEPERKS_API.
...
// is how the VS Code commands (sign in / out) update the shared config so the change
// applies to every adapter on the machine and persists across sessions.
